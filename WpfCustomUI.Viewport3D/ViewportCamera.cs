...
public sealed class ViewportCamera
{
    ...
    public Matrix4x4 GetViewMatrix() =>
        Matrix4x4.CreateLookAt(GetEyePosition(), _target, UpDirection);
    ...
    {
        var forward = -GetEyeDirection(); // 視線方向(注視点向き)
        var right = Vector3.Normalize(Vector3.Cross(forward, UpDirection));
